...
public class AdminRegisterActivity extends AppCompatActivity {
    ...
    private void registrar() {
        ...
        FirebaseManager.getInstance().registerAdmin(
                nombre, email, password,
                unused -> {
                    Toast.makeText(this, "Admin registrado con éxito", Toast.LENGTH_SHORT).show();
                    // va al dashboard
                    Intent intent = new Intent(AdminRegisterActivity.this, DashboardActivity.class);
